        ...
        <div className="max-w-4xl mx-auto">
          <div className="glass-effect rounded-3xl p-8 md:p-12">
            ...
            <div className="text-gray-600 dark:text-gray-300 space-y-4 leading-relaxed">
              <p>
                This page describes how GigFlow uses cookies and similar technologies.
              </p>
              <p>
                Add details about what cookies you use (auth, preferences, analytics) and how users can manage them.
              </p>
            </div>
          </div>
        </div>
